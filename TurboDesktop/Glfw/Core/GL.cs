...
namespace GLFW
{
    internal static unsafe class GL
    {
        ...
        public static void glBufferData(uint target, ulong size, uint[] data, uint usage)
        {
            fixed (void* ptr = data)
                _glBufferData(target, size, (IntPtr)ptr, usage);
        }
        ...
        public static void glBufferSubData(uint target, ulong offset, ulong size, float[] data)
        {
            fixed(void* ptr = data)
            _glBufferSubData(target, offset, size, (IntPtr)ptr);
        }
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void PFNGLUNIFORMMATRIX4FVPROC(int location, int count, bool transpose, in Matrix4x4 value);
        private static PFNGLUNIFORMMATRIX4FVPROC _glUniformMatrix4fv;
        public static void glUniformMatrix4fv(int location, int count, bool transpose, in Matrix4x4 value) => _glUniformMatrix4fv(location, count, transpose, in value);
